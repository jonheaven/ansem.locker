export const es = {
  ...
  home: {
    ...
    hero: {
      ...
      why: {
        ...
        tagline: 'Menos float, prueba pública y un ranking para toros que guardan — no solo tuitean.',
      },
      how: {
        headline: 'Cómo funciona',
        tagline: 'Conectar → bloquear → aprobar una vez. Jupiter Lock en Solana — auditado y open source.',
      },
      locks: {
        headline: 'Mis bloqueos',
        tagline: 'Tus escrow activos — reclama aquí cuando llegue la fecha.',
      },
      locksClaim: {
        tagline: 'Fecha pasada — reclama tu ANSEM con una firma de wallet.',
      },
    },
  },
  trust: {
  ...
  lock: {
    ...
    customUnlockTime: 'Hora de desbloqueo personalizada',
    duration5m: '5m',
    duration1y: '1a',
    preset10m: '10m',
    preset1h: '1h',
  ...
  tools: {
    ...
    calculatorCurrency: 'Moneda mostrada',
    ...
    calculatorNote:
      'Usa el mismo precio en vivo que el ticker del encabezado. La moneda aquí es solo para esta calculadora y no cambia la configuración del sitio.',
